...
import static com.st.letter.lib.server.CoreServer.FN;
import static com.st.letter.lib.server.CoreServer.UPLOAD;
import static com.st.letter.lib.server.CoreServer.UPLOAD_PATH;
    ...
    private void writeHttpData(InterfaceHttpData data) {
        if (data.getHttpDataType() == InterfaceHttpData.HttpDataType.Attribute) {
            ...
            if (data.getHttpDataType() == InterfaceHttpData.HttpDataType.FileUpload) {
                ...
                Log.d(TAG, "internalAttribute ??? wtf ???");
            }
        }
    }
